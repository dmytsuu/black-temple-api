...
ActiveRecord::Schema.define(version: 0) do
  ...
  create_table "ip_banned", primary_key: ["ip", "banned_at"], options: "ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC", comment: "Banned IPs", force: :cascade do |t|
  ...
  create_table "realmcharacters", primary_key: ["realmid", "acctid"], options: "ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC", comment: "Realm Character Tracker", force: :cascade do |t|
  ...
  create_table "uptime", primary_key: ["realmid", "starttime"], options: "ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC", comment: "Uptime system", force: :cascade do |t|
